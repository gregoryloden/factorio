...
MACHINE_STATS_BY_PRODUCTION_MODE = {
	SPEEDRUN: {
		FURNACE: {
			MACHINE_CRAFT_RATE: 2
		},
		ASSEMBLER: {
			MACHINE_CRAFT_RATE: 0.75
		},
		CHEMICAL_PLANT: {
			MACHINE_CRAFT_RATE: 1
		},
		FLUID_CHEMICAL_PLANT: {
			MACHINE_CRAFT_RATE: 1
		},
		RESOURCE: {
			BELT_SPEED: 15
	...
	MEGABASE: {
		FURNACE: {
			MACHINE_PRODUCTIVITY: 1.2,
			BELT_SPEED: MEGABASE_BELT_SPEED
		},
		ASSEMBLER: {
			MACHINE_PRODUCTIVITY: 1.4,
			BELT_SPEED: MEGABASE_BELT_SPEED
		},
		CHEMICAL_PLANT: {
			MACHINE_PRODUCTIVITY: 1.3,
			BELT_SPEED: MEGABASE_BELT_SPEED
		},
		FLUID_CHEMICAL_PLANT: {
			MACHINE_PRODUCTIVITY: 1.3
...
for desired_output in SEQUENTIAL_DESIRED_OUTPUTS:
	print_desired_output_and_machine_speeds(desired_output, SPEEDRUN)
# science_desired_output = {
	# AUTOMATION: 1,
	# LOGISTIC: 1,
# #	MILITARY: 1,
	# CHEMICAL: 1,
	...
	# UTILITY: 1
# }
# rocket_desired_output = {
	# ROCKET: 1 / 1200
# }
# print_desired_output_and_machine_speeds([science_desired_output, rocket_desired_output], SPEEDRUN)

SEQUENTIAL_MEGABASE_DESIRED_OUTPUTS = [
	# {CIRCUIT: 45},
	# {ADVANCED_CIRCUIT: 45},
	# {PROCESSING: 45},
	# {CIRCUIT: 1260},
	...
	# {PROCESSING: 48.88775510204082053178}, #total for utility and space science
	# {BATTERY: 37.81},
	# {SULFURIC_ACID: 756.23},
	# {ENGINE: 37.60932944606414451982},
	# {ADVANCED_CIRCUIT: 339.99},
	# {PLASTIC: 731.37},
	# {STRUCTURE: 45},
	{WATER: 0}
]
for megabase_desired_output in SEQUENTIAL_MEGABASE_DESIRED_OUTPUTS:
	print_desired_output_and_machine_speeds(megabase_desired_output, MEGABASE)

print_desired_output_and_machine_speeds({PROCESSING: 45}, MEGABASE, extra_resources = [ADVANCED_CIRCUIT])
print_desired_output_and_machine_speeds({STRUCTURE: 45}, MEGABASE, extra_resources = [COPPER])
print_desired_output_and_machine_speeds({PROCESSING: 45}, MEGABASE, extra_resources = [IRON])
print_desired_output_and_machine_speeds({SULFURIC_ACID: 1183}, MEGABASE, extra_resources = [IRON], extra_fluid_resources = [PETROLEUM])
# print_desired_output_and_machine_speeds({UTILITY: 45}, MEGABASE, extra_resources = [PROCESSING, ENGINE, BATTERY, STEEL, STRUCTURE, CIRCUIT])
# print_desired_output_and_machine_speeds({MILITARY: 45}, MEGABASE, extra_resources = [])
# print_desired_output_and_machine_speeds({SATELLITE_LAUNCH: 45 / 1000}, MEGABASE, extra_resources = [IRON, COPPER, CIRCUIT, ADVANCED_CIRCUIT, PLASTIC, BATTERY, STEEL, PROCESSING])
# print_desired_output_and_machine_speeds({PROCESSING: 27.45918367346938993023, SPEED_MODULE: 22.95918367346938993023, UTILITY: 45}, MEGABASE, extra_resources = [CIRCUIT, ADVANCED_CIRCUIT, SULFURIC_ACID, ENGINE, BATTERY, STEEL])
# print_desired_output_and_machine_speeds({ENGINE: 37.60932944606414451982}, MEGABASE, extra_resources = [STEEL, IRON])
# print_desired_output_and_machine_speeds({AUTOMATION: 45, LOGISTIC: 45, CHEMICAL: 45, MILITARY: 45, PRODUCTION: 45, UTILITY: 45, SATELLITE_LAUNCH: 45 / 1000}, MEGABASE, extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT])
# print_desired_output_and_machine_speeds({AUTOMATION: 45, LOGISTIC: 45, CHEMICAL: 45, UTILITY: 45, SATELLITE_LAUNCH: 45 / 1000}, MEGABASE, extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT])
# print_desired_output_and_machine_speeds({SATELLITE_LAUNCH: 45 / 1000}, MEGABASE, extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY])
#stone bricks
# print_desired_output_and_machine_speeds({MILITARY: 45, PRODUCTION: 45}, MEGABASE, extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, IRON, STONE_BRICK])
#advanced circuits
# print_desired_output_and_machine_speeds(
	# {CHEMICAL: 45, MILITARY: 45, PRODUCTION: 45},
	# MEGABASE,
	# extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY, SULFURIC_ACID, ENGINE, IRON, COPPER, STONE_BRICK])
#????????????
# print_desired_output_and_machine_speeds(
	# {CHEMICAL: 45, UTILITY: 45, SATELLITE_LAUNCH: 45 / 1000},
	# MEGABASE,
	# extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY, SULFURIC_ACID, IRON, COPPER, STONE_BRICK])
#????????????
# print_desired_output_and_machine_speeds(
	# {MILITARY: 45, PRODUCTION: 45, UTILITY: 45, SATELLITE_LAUNCH: 45 / 1000},
	# MEGABASE,
	# extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY, SULFURIC_ACID, ENGINE, IRON, COPPER, STONE_BRICK])
#????????????
# print_desired_output_and_machine_speeds(
	# {MILITARY: 45, PRODUCTION: 45, UTILITY: 45},
	# MEGABASE,
	# extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY, SULFURIC_ACID, ENGINE, IRON, COPPER, STONE_BRICK])
#????????????
# print_desired_output_and_machine_speeds({ENGINE: 37.60932944606414451982}, MEGABASE, extra_resources = [STEEL, IRON])
#total iron
# print_desired_output_and_machine_speeds(
	# {MILITARY: 45, PRODUCTION: 45, SATELLITE_LAUNCH: 45 / 1000},
	# MEGABASE,
	# extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY, SULFURIC_ACID, ENGINE, IRON, COPPER, STONE_BRICK])
#total (east) green circuits
# print_desired_output_and_machine_speeds(
	# {UTILITY: 45, PRODUCTION: 45, SATELLITE_LAUNCH: 45 / 1000},
	# MEGABASE,
	# extra_resources = [STEEL, ADVANCED_CIRCUIT, CIRCUIT, BATTERY, SULFURIC_ACID, ENGINE, IRON, COPPER, STONE_BRICK, RADAR, SOLAR_PANEL])
#total copper for non-LDS and solar panel/radar circuits
# print_desired_output_and_machine_speeds(
	# {AUTOMATION: 45, LOGISTIC: 45, CHEMICAL: 45, MILITARY: 45, PRODUCTION: 45, UTILITY: 45, SATELLITE_LAUNCH: 45 / 1000},
	# MEGABASE,
	# extra_resources = [PIERCING, STRUCTURE, SOLAR_PANEL, RADAR])


# print_desired_output_and_machine_speeds(SEQUENTIAL_MEGABASE_DESIRED_OUTPUTS[0], SPEEDRUN)

print_megabase_belt_splits(ADVANCED_CIRCUIT, CIRCUIT, craft_rate_sequence=[67.3125, 47.5, 67.3125] * 7 + [67.3125, 48.125, 67.3125])
print_megabase_belt_splits(CIRCUIT, IRON, [Fraction(MEGABASE_BELT_SPEED * 10, 14)] * 34)
print_megabase_belt_splits(CIRCUIT, [CABLE, COPPER], craft_rate_sequence=[Fraction(MEGABASE_BELT_SPEED * 10, 14 * 2)] * 34)
print_megabase_belt_splits(ADVANCED_CIRCUIT, [CABLE, COPPER], craft_rate_sequence=[182.125] * 7 + [182.75])
print_megabase_belt_splits(ADVANCED_CIRCUIT, PLASTIC, craft_rate_sequence=[67.3125, 47.6116, 67.3125] + [67.3125, 47.5, 67.3125] * 7)
